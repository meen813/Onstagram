...
export default function Followingbar() {
    ...
    return (
        <div className='w-full flex justify-center item-center p-4 shadow-sm shadow-neutral-300 mb-4 rounded-lg min-h-[90px] overflow-x-auto relative z-0 bg-light-beige dark:bg-neutral-900'>
