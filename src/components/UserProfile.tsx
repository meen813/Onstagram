...
export default function UserProfile({ user }: Props) {
    const { image, username, firstname, lastname, followers, following, posts } = user;
    const info = [
    ...
    return (
        <section className="w-full flex flex-col md:flex-row items-center justify-center py-12 border-b border-neutral-300">
            ...
            <div className="md:ml-10 basis-3/1 ">
                ...
                <p className="text-xl font-bold text-center md:text-start">{firstname} {lastname}</p>
            </div>
        </section>
    )
}